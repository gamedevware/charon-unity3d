...
set EXITCODE=-2
echo Failed to execute the 'dotnet tool install dotnet-t4' command (exit code: %ERRORLEVEL%) to retrieve the latest package version from NuGet. Ensure that the 'dotnet' tool is installed and available in the 'PATH'. Check 'https://dotnet.microsoft.com/en-us/download' for the installer. 1>&2
goto Exit_Failure
