...
#pragma warning restore 1522
		...
		private sealed partial class JsonReader
		{
			...
			private Reference<T> ReadReference<T>(bool advance = true) where T : Entry
			{
		...
		internal static class Utils
		{
			...
			public static ReadOnlyCollection<T> Defererence<T>(ReadOnlyCollection<Reference<T>> collection) where T : Entry
			{
		...
		public abstract partial class Entry
		{
			...
			{
				if (this.isReadOnly)
					throw new InvalidOperationException("This Entry is read-only and can't be changed.");
			}
...
//			}
		...
		public sealed partial class Reference<T> where T : Entry
		{
			...
			private T value;
			[NonSerialized]
			private Func<string, object, Entry> valueResolver;
			...
			public T Value
			{
				get
				{
					...
					if (this.valueResolver != null)
						...
						throw new InvalidOperationException("Reference doesn't contains a value. Consider calling Resolve() before using Value.");
				}
			}
			...
			internal void Resolve(Func<string, object, Entry> resolver)
			{
