...
namespace Unity.Dynamic.Expressions
{
	class InvocationParameters
	{
		...
		public InvocationParameters(Type returnType)
		{
			if (returnType == null) throw new ArgumentNullException("returnType");

			this.ReturnType = returnType;
		}
		public InvocationParameters(Type argument1Type, string argument1Name, Type returnType)
		{
		...
		public InvocationParameters(Type argument1Type, string argument1Name, Type argument2Type, string argument2Name, Type returnType)
		{
			if (argument1Type == null) throw new ArgumentNullException("argument1Type");
		...
		public InvocationParameters(Type argument1Type, string argument1Name, Type argument2Type, string argument2Name, Type argument3Type, string argument3Name, Type returnType)
		{
			if (argument1Type == null) throw new ArgumentNullException("argument1Type");
			if (argument2Type == null) throw new ArgumentNullException("argument2Type");
		...
		public InvocationParameters(Type argument1Type, string argument1Name, Type argument2Type, string argument2Name, Type argument3Type, string argument3Name, Type argument4Type, string argument4Name, Type returnType)
		{
			if (argument1Type == null) throw new ArgumentNullException("argument1Type");
			if (argument2Type == null) throw new ArgumentNullException("argument2Type");
			if (argument3Type == null) throw new ArgumentNullException("argument3Type");
		...
		{
			var parameters = obj as InvocationParameters;
